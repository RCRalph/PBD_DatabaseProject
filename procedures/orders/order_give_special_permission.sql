CREATE PROCEDURE order_give_special_permission
...
AS BEGIN
    ...
    SET status_id = (
        ...
        FROM order_statuses
        WHERE name = IIF(
            @current_order_status_id = (SELECT id FROM order_statuses WHERE name = N'Wpłacona zaliczka'),
